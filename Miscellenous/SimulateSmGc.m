...
vTLRd_TL_2_23 = 1;%x(17);
vTLRq_TL_2_23 = 0;%x(18);
t
dphidt =1;omegaref = 1;
%Generator
% vR_G23 = (efd/Ke);
...
% if (omega_G23 > 2)
%     error('sometjing wrong');
% end
domega_G23dt = -(B_G23*(omega_G23-1) - Pm_G23/omega_G23 + (iSd_G23*vTLRd_TL_2_23 + iSq_G23*vTLRq_TL_2_23))/(2*H_G23*377);
% iTLMd_TL_2_23 = -0.7;
% iTLMq_TL_2_23 = -0.1;
%Transmission Line
