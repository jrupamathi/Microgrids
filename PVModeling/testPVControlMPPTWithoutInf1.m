...
delPdt = abs(iRd + 1i*iRq) + abs((diTLMddt + 1i*diTLMqdt)/(dvTLLddt + 1i*dvTLLqdt));%(Pref - P)/(Vref - Vt);

%delQdt = Qref - Q;
delQdt = Vref - Vt;

alpha = Kp1*((Pref - P)/Vref-Vt) + Ki1* delPInt;
