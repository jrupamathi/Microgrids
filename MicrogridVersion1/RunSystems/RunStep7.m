...
%   -0.01100476];
% x0(59)=0.6;x0(65)=0.6;
%tauL_IM2 = 0.466;tauL_IM14 = 0.466;
tic  
...
domega_IM2dt = -(tauL_IM2 + B_IM2*omega_IM2 - (3*M_IM2*iRd_IM2*iSq_IM2)/2 + (3*M_IM2*iRq_IM2*iSd_IM2)/2)/J_IM2;
...
domega_IM14dt = -(tauL_IM14 + B_IM14*omega_IM14 - (3*M_IM14*iRd_IM14*iSq_IM14)/2 + (3*M_IM14*iRq_IM14*iSd_IM14)/2)/J_IM14;
