...
%for i = 1:numel(tArray)-1
    ...
    [t,x] = ode15s(@LLMicrogridDynamics,tspan,x0);%,Options,tauL_IM2);
   % t = [t tStep'];
   % x = [x xStep'];
   % x0 = x(:,end);
%end
...
diLd_PV21dt = 377*iLq_PV21 - (377*(vTLRd_TL_5_21 + RR_PV21*iLd_PV21 - cos(Kp1_PV21*(iLd_PV21*vTLRd_TL_5_21 - Pref_PV21 + iLq_PV21*vTLRq_TL_5_21) - k1_PV21*sign(Pref_PV21 + PInt_PV21*c1_PV21 - iLd_PV21*vTLRd_TL_5_21 - iLq_PV21*vTLRq_TL_5_21) - Ki1_PV21*PInt_PV21)*(((vTLRq_TL_5_21^2)^(1/2) + vTLRd_TL_5_21^2)^(1/2)*(Kp2_PV21*(Vref_PV21 - ((vTLRq_TL_5_21^2)^(1/2) + vTLRd_TL_5_21^2)^(1/2)) + Ki2_PV21*QInt_PV21 + 1) + k2_PV21*sign(Vref_PV21 + QInt_PV21*c2_PV21 - ((vTLRq_TL_5_21^2)^(1/2) + vTLRd_TL_5_21^2)^(1/2)))))/LR_PV21;
diLq_PV21dt = - 377*iLd_PV21 - (377*(vTLRq_TL_5_21 + RR_PV21*iLq_PV21 + sin(Kp1_PV21*(iLd_PV21*vTLRd_TL_5_21 - Pref_PV21 + iLq_PV21*vTLRq_TL_5_21) - k1_PV21*sign(Pref_PV21 + PInt_PV21*c1_PV21 - iLd_PV21*vTLRd_TL_5_21 - iLq_PV21*vTLRq_TL_5_21) - Ki1_PV21*PInt_PV21)*(((vTLRq_TL_5_21^2)^(1/2) + vTLRd_TL_5_21^2)^(1/2)*(Kp2_PV21*(Vref_PV21 - ((vTLRq_TL_5_21^2)^(1/2) + vTLRd_TL_5_21^2)^(1/2)) + Ki2_PV21*QInt_PV21 + 1) + k2_PV21*sign(Vref_PV21 + QInt_PV21*c2_PV21 - ((vTLRq_TL_5_21^2)^(1/2) + vTLRd_TL_5_21^2)^(1/2)))))/LR_PV21;
dPInt_PV21dt = 377*Pref_PV21 - 377*iLd_PV21*vTLRd_TL_5_21 - 377*iLq_PV21*vTLRq_TL_5_21;
dQInt_PV21dt = 377*Vref_PV21 - 377*((vTLRq_TL_5_21^2)^(1/2) + vTLRd_TL_5_21^2)^(1/2);
