...
%RL_L19=0.0005; LL_L19=0.0002;
%RL_L11=0.0005; LL_L11=0.0002;
%RL_PV21=-0.1875; LL_PV21=-0.015;
...
omega0 = 1;
tic
tArray = [4 4.2 5 6];% 8 10 12 14 16 18 20];
...
%for i = 1:numel(tArray)-1
    tspan = [tArray(1),4.0145];%tArray(i+1)];
...
vR_G22=-(k1(2,:)*([delta_G22;omega_G22;iSd_G22;iSq_G22;iRd_G22;iF_G22;iRq_G22]-reqd))+0.000641;
...
figure(8);
plot(t,omega_IM14)
title('Rotor Mechanical states of IM2')
xlabel('Time (in seconds)');
legend('Rotor angular frequency');

figure(9);
plot(t,vTLLd_TL_1_5,'b',t,vTLLq_TL_1_5,'r');
