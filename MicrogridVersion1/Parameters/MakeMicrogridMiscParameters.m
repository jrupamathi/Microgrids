...
tauL_IM2 = 250 * horsepower2watts/(4e6);
...
% J_IM2 = 2*2*H_IM2*Sbase/omegabase^2;
% B_IM2 = 2*F_IM2*Bbase;

% LR_IM2 = 0.0998644;%+3.47857;
% LRR_IM2 = 3*3.47857/2;
% LS_IM2 = 0.098644;% + 3.47857;
% LSS_IM2 = 3*3.47857/2;
% M_IM2 = 3.47857;
% RR_IM2 = 0.01006;
% RS_IM2 = 0.1*0.0256294;
% 
...
tauL_IM14 = 250 * horsepower2watts/(4e6);

% Derive IM14 expressions
Lmr_IM14 = Lm_IM14;
Lms_IM14 = Lm_IM14;

LR_IM14 = Llr_IM14;% + 1.5*Lmr_IM14;
LS_IM14 = Lls_IM14;% + 1.5*Lms_IM14;
