function InterconnSCMicrogridPQLoad
...
Rsc = 0.00133; Lsc = 0.010516;
% load('PV21.mat', 'RL_PV21', 'LL_PV21');
% RL_PV21= -4; %LL_PV2 = -0.0131;
...
dvTLRd_TL_1_21dt = 377*dphidt*vTLRq_TL_1_21 - (377*(iLd_L21 - iTLMd_TL_1_21))/CTL_TL_1_21;
dvTLRq_TL_1_21dt = - 377*dphidt*vTLRd_TL_1_21 - (377*(iLq_L21 - iTLMq_TL_1_21))/CTL_TL_1_21;
...
diLq_Lscdt = (377*(vTLRq_TL_1_21 - Rsc*iLq_Lsc))/Lsc - 377*dphidt*iLd_Lsc;
...
figure(5);
plot(t,V1,'k',t,V21,'r',t,V22,'b',t,V23,'g');
title('Voltages at all the buses');
legend('V1','V21','V22','V23');
xlabel('Time in seconds');
ylabel('Voltages (in p.u)');

figure(6);
plot(t,phi1,'k',t,phi21,'r',t,phi22,'b',t,phi23,'g');
title('Voltage angles at all the buses');
legend('phi1','phi21','phi22','phi23');
xlabel('Time in seconds');
