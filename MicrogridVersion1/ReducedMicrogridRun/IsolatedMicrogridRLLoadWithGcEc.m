function IsolatedMicrogridRLLoadWithGcEc
...
omega0 = 1;
tic
[t,x]=ode45(@MilosSmTlWorking,[0,0.1],x0);
time  = toc
...
Vref = 1.1;
V22 = sqrt(vTLRd_TL_1_22^2 + vTLRq_TL_1_22^2);
V23 = sqrt(vTLRd_TL_1_23^2 + vTLRq_TL_1_23^2);
...
vR_G22 = -(Vref - V22);%vR_G22_ref - K21_G22*(delta_G22 - delta_G22_ref) - K26_G22*(iF_G22 - iF_G22_ref) - K25_G22*(iRd_G22 - iRd_G22_ref) - K27_G22*(iRq_G22 - iRq_G22_ref) - K23_G22*(iSd_G22 - iSd_G22_ref) - K24_G22*(iSq_G22 - iSq_G22_ref) - K22_G22*(omega_G22 - omega_G22_ref);
...
vR_G23 = -(Vref - V23);%vR_G23_ref - K21_G23*(delta_G23 - delta_G23_ref) - K26_G23*(iF_G23 - iF_G23_ref) - K25_G23*(iRd_G23 - iRd_G23_ref) - K27_G23*(iRq_G23 - iRq_G23_ref) - K23_G23*(iSd_G23 - iSd_G23_ref) - K24_G23*(iSq_G23 - iSq_G23_ref) - K22_G23*(omega_G23 - omega_G23_ref);
...
x3_G22 = omega_G22-omega0;
dx3_G22dt = domega_G22dt;

    
dTm_G22dt  = x1_G22;
dx1_G22dt = x2_G22-x1_G22/T3;
dx2_G22dt = (k*x3_G22 + k*T1*dx3_G22dt-x2_G22)/T2;

x3_G23 = omega_G23-omega0;
dx3_G23dt = domega_G23dt;

    
dTm_G23dt  = x1_G23;
dx1_G23dt = x2_G23-x1_G23/T3;
dx2_G23dt = (k*x3_G23 + k*T1*dx3_G23dt-x2_G23)/T2;
