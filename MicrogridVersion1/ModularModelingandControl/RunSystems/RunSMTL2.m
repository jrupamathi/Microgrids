...
addpath('../Parameters/FindParameters')
...
x0= transpose([ delta0 omega0 Id0 Iq0 iD0 iF0 iQ0 vdsl0 vqsl0 itld0 itlq0 itld0 itlq0]);
x0=0.5*ones(15,1);  
tic
...
vTLRq_TL_2_23 = x(15);
 ...
 dphidt = 1; 
 tauL_G23 = Tmeq_G23 - K11_G23*(delta_G23 - delta_G23_ref) - K16_G23*(iF_G23 - iF_G23_ref) - K15_G23*(iRd_G23 - iRd_G23_ref) - K17_G23*(iRq_G23 - iRq_G23_ref) - K13_G23*(iSd_G23 - iSd_G23_ref) - K14_G23*(iSq_G23 - iSq_G23_ref) - K12_G23*(omega_G23 - omega_G23_ref);
vR_G23 = vfeq_G23 - K21_G23*(delta_G23 - delta_G23_ref) - K26_G23*(iF_G23 - iF_G23_ref) - K25_G23*(iRd_G23 - iRd_G23_ref) - K27_G23*(iRq_G23 - iRq_G23_ref) - K23_G23*(iSd_G23 - iSd_G23_ref) - K24_G23*(iSq_G23 - iSq_G23_ref) - K22_G23*(omega_G23 - omega_G23_ref);
...
domega_G23dt = -(B_G23*omega_G23 - tauL_G23 + iSd_G23*vTLRd_TL_2_23 + iSq_G23*vTLRq_TL_2_23)/(2*H_G23);
...
figure(1);
plot(t,omega)
title('Rotor Mechanical states')
xlabel('Time (in seconds)');
legend('Rotor angular frequency');

DesiredEqui = x0(1:7)
Equi = x(end,1:7)
save('DataSMTLSmallC.mat');
end
