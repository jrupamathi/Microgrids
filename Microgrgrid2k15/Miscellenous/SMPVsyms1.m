...
syms i_d i_q i_fd i_kd i_kq1 i_kq2 delta omega real;
syms v_d v_q vTLLd vTLLq iTLMd iTLMq vTLRd vTLRq iPVd iPVq real
syms Tm real
...
xFin = [x;v_d; v_q; iTLMd; iTLMq; vTLRd; vTLRq; iPVd; iPVq];
dxFin = [dx;dx1];
