classdef SM7StateControl < Module
    methods
        function this = SM7StateControl(IndexName,RefFrameAngle,RefFrameSpeed)
            ...
            this.SetPoints =  sym(strcat(StateVariableNames,IndexName,'_ref')); assume(this.SetPoints,'real');
    ...
    methods(Static)
        function [StateSpace ControlInputEquations] = SM7StateControlDynamics(this)
            ...
            Tm = -K(1,:)*(this.StateVariables - this.SetPoints(1:end-2))' + Tmeq;
            vf = -K(2,:)*(this.StateVariables - this.SetPoints(1:end-2))' + vfeq;
