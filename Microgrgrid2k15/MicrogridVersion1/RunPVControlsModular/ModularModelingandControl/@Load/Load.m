classdef Load < Module
    methods
        function this = Load(IndexName,RefFrameAngle,RefFrameSpeed)
            ...
            this.StateSpace = Load.LoadDynamics(this.Parameters,this.StateVariables,this.ControllableInputs,...
                                                     this.PortInputs,this.RefFrameAngle,this.RefFrameSpeed);
        end
    end
    methods(Static)
        function StateSpace = LoadDynamics(Parameters,StateVariables,ControllableInputs,PortInputs,phi,omega0)
