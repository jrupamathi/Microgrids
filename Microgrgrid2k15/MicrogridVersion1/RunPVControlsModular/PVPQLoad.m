...
vTLRd_TL_1_23 = x(37);
vTLRq_TL_1_23 = x(38);
K1_G23 = 5.74; K2_G23 = 50.3; K3_G23 = -4.2627;
K1_G22 = 1.21; K2_G22 = 23.53; K3_G22 = -5.1444;
t
...
diPVd_PV21dt = 377*dphidt*iPVq_PV21 + (377*(vTLRd_TL_1_21 - (PL_PV21*iPVd_PV21*(vTLRd_TL_1_21^2 + vTLRq_TL_1_21^2))/(PL_PV21^2 + QL_PV21^2))*(PL_PV21^2 + QL_PV21^2))/(QL_PV21*(vTLRd_TL_1_21^2 + vTLRq_TL_1_21^2));
diPVq_PV21dt = (377*(vTLRq_TL_1_21 - (PL_PV21*iPVq_PV21*(vTLRd_TL_1_21^2 + vTLRq_TL_1_21^2))/(PL_PV21^2 + QL_PV21^2))*(PL_PV21^2 + QL_PV21^2))/(QL_PV21*(vTLRd_TL_1_21^2 + vTLRq_TL_1_21^2)) - 377*dphidt*iPVd_PV21;
