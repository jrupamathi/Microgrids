...
Vdref = 1.0046;%vTLRd_TL_1_21; 
Vqref = 0.0823;%vTLRq_TL_1_21;
...
y = [iPVd_PV21;iPVq_PV21;vTLRd_TL_1_21;vTLRq_TL_1_21];

vPVdref = Vdref + RPV*iSdref - dphidt*iSqref*LPV;
vPVqref = Vqref + RPV*iSqref + dphidt*iSdref*LPV;

% k =  [3.0460   -0.0000    0.4142    0.0000
%    -0.0000    3.0460   -0.0000    0.4142];
k = [19.5281 -0.1209 1.9710 0.0031;
    -0.1209 19.8915 -0.0531 2.0522];
vRLd = -k(1,:)*(y-xref) + vPVdref;
vRLq = -k(2,:)*(y-xref) + vPVqref;
