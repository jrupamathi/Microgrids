...
Rsc = 0.00133*300/500; Lsc = 0.010516*300/500;
...
x0iso = [0.291705
 ...
 -0.00000229315
     ...
     -0.0278891
        6.34115];
tic
faulton = 1; faultoff = 5;
ind = transpose([1 2 8 9 15:41]);
...
RL_G22 = -0.382; LL_G22 = -1.4651;
RL_G23 = -2.7549; LL_G23 = -2.1715;
            
            diSd_G22dt = 377*dphidt*iSq_G22 + (377*(vTLRd_TL_1_22 - RL_G22*iSd_G22))/LL_G22;
            diSq_G22dt = (377*(vTLRq_TL_1_22 - RL_G22*iSq_G22))/LL_G22 - 377*dphidt*iSd_G22;
            diSd_G23dt = 377*dphidt*iSq_G23 + (377*(vTLRd_TL_1_23 - RL_G23*iSd_G23))/LL_G23;
        diSq_G23dt = (377*(vTLRq_TL_1_23 - RL_G23*iSq_G23))/LL_G23 - 377*dphidt*iSd_G23;
...
if (t<faulton || t>faultoff)
    diLd_Lscdt = 377*dphidt*iLq_Lsc + (377*(vTLLd_TL_1_21-1.1 - Rsc*iLd_Lsc))/Lsc;
...
legend('Stator current magnitude of G23');
...
legend('Stator current magnitude of G22');
xlabel('Time in seconds');
ylabel('Current Magnitude (in p.u)');
