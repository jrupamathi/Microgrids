...
% H_G23 =100*H_G23; 
tic
x0 = [-1;-0.0095;0.7315; 6.497;-1.131;0.005234;0;0;-0.6209;1.37;1];
tspan = [0 2];
...
R = 0.5;
L = 0.005*377;
iInLd = iSd_G23-id; iInLq = iSq_G23-iq; 
            ...
            %PV Dynamics
            diddt = dphidt*iq - (R*id - vTLLd + (Vs*ud)/2)/L;
            diqdt = -dphidt*id - (R*iq -vTLLq + (Vs*uq)/2)/L;
