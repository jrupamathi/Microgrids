...
% RL_L3 = 100;
% LL_L3 = 0.100;
x0 = [   -0.5834    0.0334   -0.0000    0.0000   -0.9239   -1.0529    1.0000...
1.0000 0  0.5833 0.0007 1 0.0584 0.5827 0.0107   1.2225 1.5474];

Kp1 = 1*0.02; Ki1 = 1*0.08;
 Kp2 = 1*0.02; Ki2 = 1*0.08;
RR = 0.4; LR = 0.1;
...
Pref = 3.5/4;% + 1.5*(iTLMd_TL_2_23^2 + iTLMq_TL_2_23^2)*RTL; 
Qref = (0.2/4);%- 1.5*(iTLMd_TL_2_23^2 + iTLMq_TL_2_23^2)*LTL + 1.5*(vTLRd_TL_2_23^2 + vTLRq_TL_2_23^2 + vTLLd_TL_2_23^2 + vTLLq_TL_2_23^2)*CTL);%0.21-0.0036 + 0.02 - 0.1;
Vref = 1.01;
dphidt = 1; 
...
VtR = sqrt(vTLRd_TL_2_23^2+ vTLRq_TL_2_23^2);
VtL = sqrt(vTLLd_TL_2_23^2+ vTLLq_TL_2_23^2);

% LTL = 1000*(VtL - VtR)/sqrt(iTLMd_TL_2_23^2 + iTLMq_TL_2_23^2);
% delVIntdt = (Vref - VtR);    
% vR_G23=10*Kp1*(Vref - VtR) + Ki1*delVInt + 0.003729;
% vR_G23 = -(k1(2,:)*([delta_G23;omega_G23;iSd_G23;iSq_G23;iRd_G23;iF_G23;iRq_G23]-reqd1))+0.004491;%0.003729;
% Tm_G23 =  -(delta_G23+0.8637)-0.8618;
vR_G23 = -(Vref-VtR)+0.004491;
% Tm_G23 = 1;
% vR_G23 = 0.00372;
...
dvTLLd_TL_2_23dt = 377*dphidt*vTLLq_TL_2_23 - (377*(-iRd + iTLMd_TL_2_23))/CTL_TL_2_23;
dvTLLq_TL_2_23dt = - (377*(-iRq + iTLMq_TL_2_23))/CTL_TL_2_23 - 377*dphidt*vTLLd_TL_2_23;
...
% CTL = LTL*(iTLMd_TL_2_23^2 + iTLMq_TL_2_23^2)/(2*(vTLLd_TL_2_23^2 + vTLLq_TL_2_23^2));%(iTLMd_TL_2_23-iSd_G23)/sqrt(dvTLLd_TL_2_23dt^2 + dvTLLq_TL_2_23dt^2) + 0.01;
...
P = 1.5*(vTLLd_TL_2_23*iTLMd_TL_2_23 + vTLLq_TL_2_23*iTLMq_TL_2_23);
Q = 1.5*(vTLLq_TL_2_23*iTLMd_TL_2_23 - vTLLd_TL_2_23*iTLMq_TL_2_23);
delPdt = Pref - P;
% delQdt = Qref - Q;
delQdt = Vref - VtL;
...
Vcstar = (1+ Kp2*(Vref-VtL) + Ki2*delQInt);%*Vt;
vRLd = Vcstar*cos(alpha);
vRLq = Vcstar*sin(alpha);
vRRd = vTLLd_TL_2_23; vRRq = vTLLq_TL_2_23;


diRddt = (vRLd - RR*iRd - vRRd)/LR + dphidt*iRq;
diRqdt = (vRLq - RR*iRq - vRRq)/LR - dphidt*iRd;
