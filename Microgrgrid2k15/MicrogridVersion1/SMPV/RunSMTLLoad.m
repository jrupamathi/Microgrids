...
% LL_L3 = 0.100;
% x0 = 0.5*ones(15,1);
x0 = 0.8*[    0.5276   -0.4255   -0.0015   -0.0020   -1.2785    0.5762    1.0000 ...
     0.5276    -0.4357  1 0 -0.5276    0.4357 1.0095    0.0008   ];
tic  
...
% Tm_G23 = -1*(vTLRd_TL_2_23*iSd_G23 + vTLRq_TL_2_23*iSq_G23 - PPV) + 1;
Tm_G23 = Tm_Local + Tm_Global;
% vR_G23 = -1*(vTLRd_TL_2_23^2 + vTLRq_TL_2_23^2 - 1) + 0.00039;
...
domega_G23dt = -(B_G23*omega_G23 - Tm_G23 + 1.5*iSd_G23*vTLRd_TL_2_23 + 1.5*iSq_G23*vTLRq_TL_2_23)/(2*H_G23);
