%%
%10/1/16
%Case high PV PPV = -0.875 QPV=-0.01 given by switches
%Case high QPV QPV =-0.7
...
x220s = [0.47
 ...
 0.481
        1.0];
Tm220s = 0.47923; vf220s=0.001852;
...
ueq = [Tm220s; vf220s; Tm230s; vf230s ];
...
vTLRd_TL_1_23 vTLRq_TL_1_23 iPVd_PV21 iPVq_PV21 iLdInt iLqInt real 

syms tauL_G22 vR_G22 tauL_G23 vR_G23 Vs real
x = [iSd_G22; iSq_G22; iRd_G22; iRq_G22 ;iF_G22 ;delta_G22 ;omega_G22 ;
iSd_G23 ;iSq_G23 ;iRd_G23 ;iRq_G23 ;iF_G23 ;delta_G23 ;omega_G23;
iLd_L1; iLq_L1 ;iLd_L21 ;iLq_L21 ;iLd_L22  ;iLq_L22  ;iLd_L23 ;iLq_L23;
vTLLd_TL_1_21; vTLLq_TL_1_21 ;iTLMd_TL_1_21 ;iTLMq_TL_1_21 ;vTLRd_TL_1_21 ;vTLRq_TL_1_21 ;
iTLMd_TL_1_22; iTLMq_TL_1_22; vTLRd_TL_1_22;  vTLRq_TL_1_22 ;iTLMd_TL_1_23 ;iTLMq_TL_1_23 ;
vTLRd_TL_1_23 ;vTLRq_TL_1_23;iPVd_PV21 ;iPVq_PV21;Vs ];% tauL_G23; vR_G23; tauL_G22; vR_G22];
u = [tauL_G23; vR_G23; tauL_G22; vR_G22];

iLd_PV21 = -iPVd_PV21; iLq_PV21 = -iPVq_PV21;
...
%%
% options = optimoptions(@fsolve,'Display','iter','SpecifyObjectiveGradient',true,'MaxIterations',150);
% 
% [x,F,exitflag,output,JAC] = fsolve(@FunctionMaker,x0,options);
%%
Q = eye(size(A1,2));
% Q(5,5) = 1;
% Q(6,6) = 1;
