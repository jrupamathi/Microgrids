function ISolatedMicrogridWithRelay
...
persistent time t1
t1=0;
[t,x]=ode45(@MilosSmTlWorking,[0,0.07],x0);
time1  = toc
...
tau = t - time;
t1 = t;
I22 = sqrt(iSd_G22^2 + iSq_G22^2);
trip51 = relay_ANSI_51P_script(tau,I22,1.5,1,0.1);

iSd_G22 = (1-trip51)*iSd_G22;
iSq_G22 = (1-trip51)*iSq_G22;
vTLRd_TL_1_22 = (1-trip51)*vTLRd_TL_1_22;
vTLRq_TL_1_22 = (1-trip51)*vTLRq_TL_1_22;
