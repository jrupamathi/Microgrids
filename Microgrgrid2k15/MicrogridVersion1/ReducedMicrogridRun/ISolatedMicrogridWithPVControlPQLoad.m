function ISolatedMicrogridWithPVControlPQLoad
...
omega0 = 1;
Vdref = vTLRd_TL_1_21; Vqref = vTLRq_TL_1_21;
Pref = -PL_PV21; Qref = -QL_PV21;
ConvMat = [Vdref Vqref;
            Vqref -Vdref];
I = ConvMat\[Pref;Qref];
iSdref = I(1)/1.5;
...
iRd = iLd_PV21; iRq = iLq_PV21;

diLd_PV21dt = (vRLd - RR*iRd - vRRd)/LR + omega0*iRq;
diLq_PV21dt = (vRLq - RR*iRq - vRRq)/LR - omega0*iRd;
