function ISolatedMicrogridWithPVControl2PQLoad
...
tic
[t,x]=ode45(@MilosSmTlWorking,[0,6.0],x0);
time  = toc
...
Vs = 1; P = -0.1875;Q = -0.01;

vTLLd = vTLLd_TL_1_21; vTLLq = vTLLq_TL_1_21;            
vd = vTLLd; vq = vTLLq;
% vd = 1;vq = 0.01;
% id_star = -1; iq_star = -0.0095;
...
L = 0.005*377;
            ...
            ud = (2*(R*id_star - L*iq_star*dphidt))/Vs;%+vTLLd;
            uq = (2*(R*iq_star + L*id_star*dphidt))/Vs;%+vTLLq;
id = iLd_PV21; iq = iLq_PV21;
            %PV Dynamics
            diLd_PV21dt = dphidt*iq - (R*id - vTLLd + (Vs*ud)/2)/L;
            diLq_PV21dt = -dphidt*id - (R*iq -vTLLq + (Vs*uq)/2)/L;
