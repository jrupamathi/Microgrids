function ISolatedMicrogridWithPVPQLoad
...
load('L1.mat', 'PL_L1', 'QL_L1');
load('L21.mat', 'PL_L21', 'QL_L21');
load('L22.mat', 'PL_L22', 'QL_L22');
load('L23.mat', 'PL_L23', 'QL_L23');
load('PV21.mat', 'PL_PV21', 'QL_PV21');
PL_PV21 =-0.1875; QL_PV21 = -0.08; 
% PL_PV21 =-0.6227; QL_PV21 = -1.0904; 
...
vR_G22 = vR_G22_ref - K26_G22*(iF_G22 - 2.56*iF_G22_ref);% - K25_G22*(iRd_G22 - iRd_G22_ref) - K27_G22*(iRq_G22 - iRq_G22_ref) - K23_G22*(iSd_G22 - iSd_G22_ref) - K24_G22*(iSq_G22 - iSq_G22_ref) - K22_G22*(omega_G22 - omega_G22_ref);
tauL_G23 = tauL_G23_ref - K11_G23*(delta_G23 - delta_G23_ref) - K12_G23*(omega_G23 - omega_G23_ref);
vR_G23 = vR_G23_ref - K26_G23*(iF_G23 - 0.6*iF_G23_ref);% - K25_G23*(iRd_G23 - iRd_G23_ref) - K27_G23*(iRq_G23 - iRq_G23_ref) - K23_G23*(iSd_G23 - iSd_G23_ref) - K24_G23*(iSq_G23 - iSq_G23_ref) - K22_G23*(omega_G23 - omega_G23_ref);
...
diLd_L1dt = 377*dphidt*iLq_L1 + (377*(vTLLd_TL_1_21 - (PL_L1*iLd_L1)/(PL_L1^2 + QL_L1^2))*(PL_L1^2 + QL_L1^2))/QL_L1;
diLq_L1dt = (377*(vTLLq_TL_1_21 - (PL_L1*iLq_L1)/(PL_L1^2 + QL_L1^2))*(PL_L1^2 + QL_L1^2))/QL_L1 - 377*dphidt*iLd_L1;
diLd_L21dt = 377*dphidt*iLq_L21 + (377*(vTLRd_TL_1_21 - (PL_L21*iLd_L21)/(PL_L21^2 + QL_L21^2))*(PL_L21^2 + QL_L21^2))/QL_L21;
diLq_L21dt = (377*(vTLRq_TL_1_21 - (PL_L21*iLq_L21)/(PL_L21^2 + QL_L21^2))*(PL_L21^2 + QL_L21^2))/QL_L21 - 377*dphidt*iLd_L21;
diLd_L22dt = 377*dphidt*iLq_L22 + (377*(vTLRd_TL_1_22 - (PL_L22*iLd_L22)/(PL_L22^2 + QL_L22^2))*(PL_L22^2 + QL_L22^2))/QL_L22;
diLq_L22dt = (377*(vTLRq_TL_1_22 - (PL_L22*iLq_L22)/(PL_L22^2 + QL_L22^2))*(PL_L22^2 + QL_L22^2))/QL_L22 - 377*dphidt*iLd_L22;
diLd_L23dt = 377*dphidt*iLq_L23 + (377*(vTLRd_TL_1_23 - (PL_L23*iLd_L23)/(PL_L23^2 + QL_L23^2))*(PL_L23^2 + QL_L23^2))/QL_L23;
diLq_L23dt = (377*(vTLRq_TL_1_23 - (PL_L23*iLq_L23)/(PL_L23^2 + QL_L23^2))*(PL_L23^2 + QL_L23^2))/QL_L23 - 377*dphidt*iLd_L23;
...
diLd_PV21dt = 377*dphidt*iLq_PV21 + (377*(vTLRd_TL_1_21 - (PL_PV21*iLd_PV21)/(PL_PV21^2 + QL_PV21^2))*(PL_PV21^2 + QL_PV21^2))/QL_PV21;
diLq_PV21dt = (377*(vTLRq_TL_1_21 - (PL_PV21*iLq_PV21)/(PL_PV21^2 + QL_PV21^2))*(PL_PV21^2 + QL_PV21^2))/QL_PV21 - 377*dphidt*iLd_PV21;
dx = [diSd_G22dt
diSq_G22dt
diRd_G22dt
diRq_G22dt
...
title('Voltages at all the buses (P-Q loads)');
