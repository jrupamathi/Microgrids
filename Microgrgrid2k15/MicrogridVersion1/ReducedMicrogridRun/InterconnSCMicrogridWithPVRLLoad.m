function InterconnSCMicrogridWithPVRLLoad
...
diLd_Lscdt = 377*dphidt*iLq_Lsc + (377*(vTLRd_TL_1_21-1*1 - Rsc*iLd_Lsc))/Lsc;
diLq_Lscdt = (377*(vTLRq_TL_1_21-1*sin(acos(1)) - Rsc*iLq_Lsc))/Lsc - 377*dphidt*iLd_Lsc;
