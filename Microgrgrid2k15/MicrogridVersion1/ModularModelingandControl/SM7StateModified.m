classdef SM7StateModified < Module
    methods
        function this = SM7StateModified(IndexName,RefFrameAngle,RefFrameSpeed)
            ParameterNames={'Lad','Laf','Laq','Ldf','LSd','LSq','LRD','LF','LRQ','RS','Rkd','RF','H','B','Tm','vR','Rkq'};
            ...
            this.StateSpace = SM7StateModified.SM7StateModifiedDynamics(this.Parameters,this.StateVariables,this.ControllableInputs,...
                                                                             this.PortInputs,this.RefFrameAngle,this.RefFrameSpeed);
        end
    end
    methods(Static)
        function StateSpace = SM7StateModifiedDynamics(Parameters,StateVariables,ControllableInputs,PortInputs,phi,omega0)
