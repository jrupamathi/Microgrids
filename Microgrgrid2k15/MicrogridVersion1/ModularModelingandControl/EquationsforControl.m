...
load('G23.mat','Lad_G23','Laf_G23','Laq_G23','Ldf_G23','LSd_G23','LSq_G23',...
    'LRD_G23','LF_G23','LRQ_G23','RS_G23','RR_G23','RF_G23','H_G23','B_G23')
...
I = [Id; Iq];
i = [iD; iF; iQ];
%vd = 0.998;vq=-0.006; % From Load flow
...
omegadot = 1/2/H*(Tm - F*omega - 1.5*(vds*Id+vqs*Iq));

x=[I;i;delta;omega];u=[Tm;vf]; 
xdot = [ Idot; idot; deltadot; omegadot  ];
...
% P = 5.71/4; Q = 3.76/4;
P = -3.5/4; Q = -0.2/4;
I=solve(1.5*[vd*Id+ vq*Iq ;vq*Id- vd*Iq] - [P;Q]); % From Load flow
...
x0s=[I.Id;I.Iq;iD0s;iF0s;iQ0s;delta0s;omega0s];
As=subs(Jx,x,x0s);
