function RunLLMicrogridSMTLModified
...
diLd_L2dt = 377*dphidt*iLq_L2 + (377*(vTLLd_TL_2_23 - (PL_L2*iLd_L2)/(PL_L2^2 + QL_L2^2))*(PL_L2^2 + QL_L2^2))/QL_L2;
diLq_L2dt = (377*(vTLLq_TL_2_23 - (PL_L2*iLq_L2)/(PL_L2^2 + QL_L2^2))*(PL_L2^2 + QL_L2^2))/QL_L2 - 377*dphidt*iLd_L2;
