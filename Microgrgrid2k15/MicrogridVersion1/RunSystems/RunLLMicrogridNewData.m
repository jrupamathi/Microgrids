function RunLLMicrogridNewData
...
%Gen22 steady state
[x220,u220,K22] = FindGenEqui(status,23,1);
u220 = double(u220); K22 = double(K22);
tauL_G22_ref = u220(1); vR_G23_ref = u220(2);
...
%for i = 1:numel(tauL_W1Array)
    ...
    [t,x] = ode45(@LLMicrogridDynamics,[0,1],x0,Options);
...
domega_G23dt = -(iSd_G23*vTLLd_TL_1_2 - tauL_G23 + iSq_G23*vTLLq_TL_1_2 + B_G23*(omega_G23 - 1))/(2*H_G23);
I = (-0.875 - 1i* 0.01)/(vTLRd_TL_8_21 + 1i* vTLRq_TL_8_21);
